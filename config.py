...
def get_args():
    ...
    parser.add_argument('--WPuQ_location',      type = str, default = None)
    ...
    parser.add_argument('--dataset_code',       type = str,   default = 'WPuQ', choices=['redd_lf', 'uk_dale','refit', 'WPuQ'])
    ...
    parser.add_argument('--appliance_names',    type = list,  default = ['HEATPUMP'])
    ...
    parser.add_argument('--window_stride',       type = int,   default = 30)
...
#################### ARGUMENTS FOR FEDERATED LEARNING##############
    ...
    parser.add_argument("--max_communication_rounds", default=2, type=int,  help="Total communication rounds")
    ...
    parser.add_argument("--split_type", type=str, choices=["split_1", "split_2", "split_3", "real", "central"], default="real", help="Which data partitions to use")
    parser.add_argument('--dis_cvs_files', type = list, default = ['none'])
   

    

    #########Metric arguments#######
    parser.add_argument("--test_metrics", type = dict, default={}, help = "Dictionary for test results of every client")
    parser.add_argument("--train_metrics", type = dict, default={}, help = "Dictionary for train results of every client")
    parser.add_argument("--val_metrics", type = dict, default={}, help = "Dictionary for val results of every client")
...
def update_preprocessing_parameters(args):
    ...
    if args.dataset_code == 'WPuQ':
        args.house_indicies = [ 3, 4, 5, 7, 9, 10, 12, 14, 16, 18, 19, 21, 22, 23, 27, 28, 29, 30, 32, 34, 36, 38, 39]
